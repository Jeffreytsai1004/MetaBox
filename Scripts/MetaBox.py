...
TOOLBOX_AUTHOR = "CGNICO"
CURRENT_LANG = 'en_US'
TOOL_WSCL_NAME = "MetaBoxWorkSpaceControl"
TOOLBOX_HELP = f"https://gitea.cgnico.com/CGNICO/MetaBox/wiki"
...
def show():
    ...
    def create_ui(retry_count=0, width=300):
        ...
        try:
            ...
            cmds.evalDeferred(lambda: cmds.workspaceControl(TOOL_WSCL_NAME, e=True, width=width))
            cmds.evalDeferred(lambda: cmds.workspaceControl(TOOL_WSCL_NAME, e=True, resizeWidth=True))
        except Exception as e:
            if retry_count < 3:
