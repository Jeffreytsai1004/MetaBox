...
"}")
    ...
    def retranslateUi(self, ziRailWindow):
        ...
        self.pickSrcBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"设置源", None, -1))
        self.refBox.setText(QtWidgets.QApplication.translate("ziRailWindow", u"作为参考", None, -1))
        self.box1.setProperty("title", QtWidgets.QApplication.translate("ziRailWindow", u"细分", None, -1))
        self.lockedPinchChk.setText(QtWidgets.QApplication.translate("ziRailWindow", u"收缩", None, -1))
        self.slidBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"重置", None, -1))
        ...
        self.displayProjBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"Proj. 距离", None, -1))
        self.bridg_lab.setText(QtWidgets.QApplication.translate("ziRailWindow", u" 桥接 Subs:", None, -1))
        self.reversBridgBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"反转", None, -1))
        self.tweakBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"扭曲模式", None, -1))
        self.box2.setProperty("title", QtWidgets.QApplication.translate("ziRailWindow", u"应用程序", None, -1))
        self.viewportBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"显示视口UI", None, -1))
        self.shaderApplyBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"切换", None, -1))
        self.box3.setProperty("title", QtWidgets.QApplication.translate("ziRailWindow", u"笔刷特性", None, -1))
        self.moverad_lab.setText(QtWidgets.QApplication.translate("ziRailWindow", u"移动半径:", None, -1))
        self.relaxrad_lab.setText(QtWidgets.QApplication.translate("ziRailWindow", u"松弛半径:", None, -1))
        self.relaxint_lab.setText(QtWidgets.QApplication.translate("ziRailWindow", u"松弛强度:", None, -1))
        self.relaxBrBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"松弛笔刷", None, -1))
        self.moveBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"移动笔刷", None, -1))
        self.freezeBBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"冻结笔刷", None, -1))
        self.backfBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"背面消隐", None, -1))
        self.freezeBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"冻结边框", None, -1))
        self.box4.setProperty("title", QtWidgets.QApplication.translate("ziRailWindow", u"绘制", None, -1))
        self.ziRailLaunchBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"轨道模式", None, -1))
        self.quadBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"切换四边形绘图模式", None, -1))
        self.lazyBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"懒惰模式", None, -1))
        self.lazySpinStrength.setPrefix(QtWidgets.QApplication.translate("ziRailWindow", u"强度: ", None, -1))
        self.lazySpinDist.setPrefix(QtWidgets.QApplication.translate("ziRailWindow", u"距离: ", None, -1))
        self.closeStrokeBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"关闭stroke", None, -1))
        self.box5.setProperty("title", QtWidgets.QApplication.translate("ziRailWindow", u"对称", None, -1))
        self.symmetryBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"对称", None, -1))
        self.freezeSymBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"冻结中间轴", None, -1))
        self.logLab.setText(QtWidgets.QApplication.translate("ziRailWindow", "...", None, -1))
        self.helpBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"禁用帮助", None, -1))
        self.hotkeyBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"热键", None, -1))
        self.hintsBtn.setText(QtWidgets.QApplication.translate("ziRailWindow", u"禁用热键", None, -1))
        self.hudChk.setText(QtWidgets.QApplication.translate("ziRailWindow", u" HUD显示", None, -1))
        self.updateChk.setText(QtWidgets.QApplication.translate("ziRailWindow", u"检查更新", None, -1))
